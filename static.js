...
function init3DMap() {
    map = new maplibregl.Map({
        ...
        zoom: 14.2,
        pitch: 58,       // Vue plongeante 3D
        bearing: -18,    // Angle de vue esthetique
        antialias: true
    });
...
function afficherResultats(data) {
    ...
    data.etablissements.forEach(item => {
        ...
        el.style.boxShadow = `0 0 14px ${item.couleur_hex}`;
    ...
    // Fly-to avec perspective 3D sur l'arrondissement
    map.flyTo({
