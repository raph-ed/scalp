...
async def collecter_donnees_secteur(code_postal: str, secteur: str) -> List[Dict[str, Any]]:
            ...
            try:
                ...
                for item in elements:
                    ...
                    try:
                        ...
                        # Dispersion autour du centre de l'arrondissement si non géolocalisé
    ...
    # Complément pour garantir 20 commerces minimum
    if len(results) < 20:
        ...
        for i in range(1, manquants + 1):
            ...
            # Répartition radiale propre dans l'arrondissement
